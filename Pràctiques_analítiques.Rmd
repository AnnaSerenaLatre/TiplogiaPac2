...
```{r}
library(readr)
Train_T <- read_csv("C:/Users/ANNA/Desktop/Tipologia i cicle de vida de les dades/TipologiaPAC2/Train_T.csv")

Test_T <- read_csv("C:/Users/ANNA/Desktop/Tipologia i cicle de vida de les dades/TipologiaPAC2/Test_T.csv")
```
```{r}
names(Test_T)
```
...
# Analítica: Models de classificació, regressió i segmentació.
...
auc
```
## Algorisme SVM : Suported Vectorial Machine.
```{r}
library(kernlab)
...
## Arbres de predicció.
### Prova Train$Test per al model d'arbre.
